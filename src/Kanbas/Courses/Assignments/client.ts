...
export const getAssignments = async (courseId: string) => {
    console.log(`ASSIGNMENT CLIENT: get ${ASSIGNMENTS_API}/${courseId}`)
...
export const getAssignment = async (assignmentId: string, courseId: string) => {
    console.log(`ASSIGNMENT CLIENT: get ${ASSIGNMENTS_API}/${courseId}/${assignmentId}`);
...
export const createAssignment = async (assignment: any) => {
    console.log(`ASSIGNMENT CLIENT: post ${ASSIGNMENTS_API}`)
...
export const deleteAssignment = async (assignmentId: string) => {
    console.log(`ASSIGNMENT CLIENT: delete ${ASSIGNMENTS_API}/${assignmentId}`);

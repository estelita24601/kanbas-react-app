        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    ...
                    <li>Heat the pot on the stove until water is boiling.</li>
                    <li>Add pasta to the pot.</li>
                    <li>Continue to heat pot on the stove at a light simmer.</li>
                    <li>After 10 minutes remove pot from the stove and drain water before serving.</li>
                </ol>
            ...
            <div id="wd-tables">
                ...
                <table border={1} width="100%">
                    ...
                    {/*MAKE THE REST OF THE TABLE ROW BY ROW*/}
                    <tbody>
                    <tr>
                        <td>Q1</td>
                        <td>HTML</td>
            ...
            <div id="wd-images">
                ...
                <br/>
                {/*FIXME*/}
                <img id="wd-teslabot" src="../../../public/images/teslabot.jpg" height="1424"
                />
            </div>
